                                        ...
                                        <div class="owl_item_product">
                                            ...
                                            <div class="product-box">
                                                <div class="product-thumbnail">
                                                    ...
                                                    <a href="/giay-converse-cao-cap" class="image_link display_flex" data-images="//bizweb.dktcdn.net/thumb/medium/100/286/794/products/1min.jpg?v=1516862311680" title="Chuck Taylor All Star Converse Wordmark">
    
    
                                                        <img class="img-responsive lazyload" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" data-src="//bizweb.dktcdn.net/thumb/medium/100/286/794/products/1min.jpg?v=1516862311680" alt="chuck-taylor-all-star-converse-wordmark" />
    
    
                                                    </a>
                                                    <div class="product-action-grid clearfix">
                                                        <form action="/cart/add" method="post" class="variants form-nut-grid" data-id="product-actions-9746951" enctype="multipart/form-data">
                                                            <div>
                                                                <a title="xem nhanh" href="/giay-converse-cao-cap" data-handle="giay-converse-cao-cap" class="button_wh_40 btn_view right-to quick-view"><i class="fa fa-search"></i>
                                                                    <span class="tooltips qv"><span>Xem nhanh</span></span>
                                                                </a>
                                                            </div>
                                                        </form>
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <div class="reviews-product-list grid_reviews">
                                                        <div class="bizweb-product-reviews-badge" data-id="9746951"></div>
                                                    </div>
    
                                                    <h3 class="product-name"><a class="text2line" href="/giay-converse-cao-cap" title="Chuck Taylor All Star Converse Wordmark">Chuck Taylor All Star Converse Wordmark</a></h3>
                                                    ...
                                                    <div class="action__">
                                                        ...
                                                        <form action="/cart/add" method="post" class="variants form-nut-grid" data-id="product-actions-9746951" enctype="multipart/form-data">
                                                            <div>
                                                                ...
                                                                <input class="hidden" type="hidden" name="variantId" value="15567673" />
                                                                <button class="btn-cart cart_button_style  left-to" title="Chọn sản phẩm" type="button" onclick="window.location.href='/giay-converse-cao-cap'">
                                                                    <span class="ti-settings"></span>
                                                                    Tuỳ chọn
                                                                </button>
